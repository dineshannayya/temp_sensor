...
if {[info exists ::env(FOOTPRINT)]} {
   puts "Dinesh-A: Step-1: FOOT PRINT "
...
# ----------------------------------------------------------------------------
   ...
   puts "Dinesh-A: Step-2: CORE UTILIZATION "
...
# ----------------------------------------------------------------------------
  ...
  initialize_floorplan -die_area $::env(DIE_AREA) \
   ...
   if {[info exist ::env(DOMAIN_INSTS_LIST)]} {
    puts "Dinesh-A: Step-3.1: DOMAIN_INSTS_LIST "
...
if { [info exists ::env(MAKE_TRACKS)] } {
  puts "Dinesh-A: Step-4: MAKE TRACKS source"
  ...
  puts "Dinesh-A: Step-6: MAKE TRACKS command "
  make_tracks
}

if {[info exists ::env(FOOTPRINT_TCL)]} {
  puts "Dinesh-A: Step-7: FOOT PRINT TCL"
...
if { [info exist ::env(RESYNTH_TIMING_RECOVER)] && $::env(RESYNTH_TIMING_RECOVER) == 1 } {
  puts "Dinesh-A: Step-8: RESTNTH TIMING RECOVER"
  repair_design
  repair_timing
...
if { [info exist ::env(RESYNTH_AREA_RECOVER)] && $::env(RESYNTH_AREA_RECOVER) == 1 } {
  ...
  puts "Dinesh-A: Step-9: RESTNTH TIMING RECOVER"
...
if { [info exists ::env(POST_FLOORPLAN_TCL)] } {
  puts "Dinesh-A: Step-10: POST_FLOORPLAN_TCL"
  source $::env(POST_FLOORPLAN_TCL)
}

if {![info exists save_checkpoint] || $save_checkpoint} {
  puts "Dinesh-A: Step-11: save_checkpoint"
