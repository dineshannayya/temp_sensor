...
foreach inst $all_insts {
  if {[[$inst getMaster] getName] eq "sky130_fd_sc_hd__tapvpwrvgnd_1" || \
      [[$inst getMaster] getName] eq "sky130_fd_sc_hd__fill_1" || \
      [[$inst getMaster] getName] eq "sky130_fd_sc_hd__fill_2" || \
      [[$inst getMaster] getName] eq "sky130_ef_sc_hd__decap_12" || \
      [[$inst getMaster] getName] eq "sky130_fd_sc_hd__decap_3" || \
      [[$inst getMaster] getName] eq "sky130_fd_sc_hd__decap_4" || \
      [[$inst getMaster] getName] eq "sky130_fd_sc_hd__decap_6" || \
      [[$inst getMaster] getName] eq "sky130_fd_sc_hd__decap_8"} {
